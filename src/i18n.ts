      ...
      ko: {
        translation: {
          common: {
            ...
            upload_unsupported_type: 'JPEG, PNG, WebP 또는 AVIF 이미지를 선택해 주세요.',
            upload_file_too_large: '이미지 파일은 25MB 이하여야 합니다.',
            loading: '데이터를 불러오는 중…',
            no_results: '결과 없음',
          ...
          crop: {
            ...
            apply_portrait: '적용하기',
            processing: '처리 중…',
            processing_failed: '이미지를 자르지 못했습니다. 다시 시도해 주세요.',
            hint_move: '사진 이동',
            hint_zoom: '크기 조절',
            hint_confirm: '선택 완료'
          }
      ...
      en: {
        translation: {
          common: {
            ...
            upload_unsupported_type: 'Choose a JPEG, PNG, WebP, or AVIF image.',
            upload_file_too_large: 'The image file must be 25 MB or smaller.',
          ...
          crop: {
            ...
            processing_failed: 'Could not crop the image. Please try again.',
      ...
      ja: {
        translation: {
          common: {
            ...
            drop_image: 'ここへドロップ',
            upload_unsupported_type: 'JPEG、PNG、WebP、AVIF画像を選択してください。',
            upload_file_too_large: '画像ファイルは25MB以下にしてください。',
            loading: 'データを読み込み中…',
            no_results: '結果なし',
          ...
          crop: {
            ...
            apply_portrait: '適用する',
            processing: '処理中…',
            processing_failed: '画像を切り抜けませんでした。もう一度お試しください。',
            hint_move: '写真の移動',
            hint_zoom: 'ズーム',
            hint_confirm: '選択を確定'
          }
